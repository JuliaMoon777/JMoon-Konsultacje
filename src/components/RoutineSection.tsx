...
export const RoutineSection: React.FC = () => {
  ...
  // Dynamic reviews for KODY CIAŁA
  const reviews = getReviewsByService('KODY CIAŁA');
  ...
  return (
    ...
    >
      <div id="twoja-rutyna" className="sr-only" aria-hidden="true" />
      ...
      >
        ...
        <div className="relative z-30 flex flex-wrap items-center justify-between gap-4 pb-2">
          <div id="routine-rating-block" className="relative z-30 flex items-center gap-3">
            {reviewCount === 0 ? (
        ...
        {/* =========================================================================
           ...
           ========================================================================= */}
        <div id="routine-cta-container" className="mt-12 sm:mt-16 space-y-4 max-w-xl">
          <a
          ...
          >
            Kliknij i napisz w Direct: <span className="text-[#E8B58E] font-normal">„Kody ciała”</span>. Wyślę Ci link do płatności oraz kilka pytań potrzebnych do przygotowania analizy.
          </p>
        </div>
      </div>
